...
def ring_signature(siging_key, key_idx, M, L, G=SECP256k1.generator, hash_func=hashlib.sha3_256):
    """
...
def verify_ring_signature(message, L, c_0, s, Y, G=SECP256k1.generator, hash_func=hashlib.sha3_256):
    """
